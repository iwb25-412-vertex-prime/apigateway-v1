    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {quickActions.map((action, index) => (
            <div key={index} className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
              {action.disabled ? (
                ...
                <Link href={action.href} className="block p-6 hover:bg-slate-50 transition-colors">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow duration-200">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-sm text-slate-400 mt-1">Activity will appear here as you use your API keys</p>
        </div>
      </div>
    </div>
  );
